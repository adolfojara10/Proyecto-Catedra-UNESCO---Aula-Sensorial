...
def escogerEstudiante():
    ...
    return render_template('escogerEstudiante.html', title='Estudiante')
...
def registrarEstudiante():
    ...
    if form.is_submitted():
        ...
        estu = Estudiante(nombre=form.nombre.data, apellido=form.apellido.data, genero=form.genero.data, fechaNacimiento=form.fechaNacimiento.data,
